    ...
    <>
      ...
      <div className="home-container">
        ...
        <p className="home-desc">
          Lyric Market is your one-stop destination for searching song lyrics
        ...
        <p className="home-action">
          Start your search now by navigating to the <b>Lyrics Finder</b> page,
          or contribute by adding new lyrics!
        </p>
      </div>
    </>
  );
